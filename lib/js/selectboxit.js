/**
 * Created by Design II_2 on 6/28/2016.
 */
(function (c) {
    ...
    c.widget("selectBox.selectBoxIt", {
        ...
        _createUnorderedList: function () {
            var a = this, b, d, f, h, g, e, k, l = "", p = a.originalElemId || "", p = c("<ul/>", {
        ...
        _eventHandlers: function () {
            var a = this, b = a.options.nativeMousedown, d = a.options.customShowHideEvent, f, h, g = a.focusClass, e = a.hoverClass, k = a.openClass;
            this.dropdown.on({
    ...
    e.enableOption = function (a, b) {
        var d;
        "number" === c.type(a) && (d = this.selectBox.find("option").eq(a), this.triggerEvent("enable-option"), d.removeAttr("disabled"),
            this.listItems.eq(a).attr("data-disabled", "false").removeClass(this.theme.disabled));
        this._callbackSupport(b);
        return this
    };
    e.moveDown = function (a) {
        ...
        if (this.currentFocus === this.listItems.length)--this.currentFocus; else {
            ...
            b && !d ? --this.currentFocus :
                (this.listItems.eq(this.currentFocus - 1).blur().end().eq(this.currentFocus).focusin(), this._scrollToView("down"), this.triggerEvent("moveDown"))
        }
        this._callbackSupport(a);
        return this
    };
    e.moveUp = function (a) {
        ...
        if (-1 === this.currentFocus)this.currentFocus += 1; else {
            ...
            b && !d ? this.currentFocus += 1 : (this.listItems.eq(this.currentFocus + 1).blur().end().eq(this.currentFocus).focusin(), this._scrollToView("up"), this.triggerEvent("moveUp"))
        }
        this._callbackSupport(a);
        return this
    };
    e._setCurrentSearchOption = function (a) {
        (this.options.aggressiveChange || this.options.selectWhenHidden || this.listItems.eq(a).is(":visible")) && !0 !== this.listItems.eq(a).data("disabled") && (this.listItems.eq(this.currentFocus).blur(), this.currentFocus = this.currentIndex = a, this.listItems.eq(this.currentFocus).focusin(),
            this._scrollToView("search"), this.triggerEvent("search"));
        return this
    };
    e._searchAlgorithm = function (a, b) {
        var d = !1, c, h, g, e, k = this.textArray, l = this.currentText;
        c = a;
        for (g = k.length; c < g; c += 1) {
            ...
            if (3 > l.length) {
                if (b = new RegExp(l.charAt(0), "gi"), -1 !== e.charAt(0).search(b)) {
                    ...
                    if (e.substring(0, l.length).toLowerCase() !==
                        l.toLowerCase() || this.options.similarSearch)this.currentIndex += 1;
                    return !1
                }
    ...
    e.search = function (a, b, d) {
        ...
        this._searchAlgorithm(this.currentIndex, new RegExp(this.currentText, "gi")) && this._searchAlgorithm(0,
            this.currentText);
        this._callbackSupport(b);
        return this
    };
    ...
    e.selectOption = function (a,
                               b) {
        var d = c.type(a);
        "number" === d ? this.selectBox.val(this.selectItems.eq(a).val()).change() : "string" === d && this.selectBox.val(a).change();
        this._callbackSupport(b);
        return this
    };
    ...
    e.wait = function (a, b) {
        this.widgetProto._delay.call(this,
            b, a);
        return this
    };
    e.add = function (a, b) {
        this._populate(a, function (a) {
            var f = this, e = c.type(a), g = 0, n, k = [], l = (n = f._isJSON(a)) && f._parseJSON(a);
            ...
            } else a && "string" === e && !f._isJSON(a) ? f.selectBox.append(a) :
                a && "object" === e ? f.selectBox.append(c("<option/>", a)) : a && f._isJSON(a) && c.isPlainObject(f._parseJSON(a)) && f.selectBox.append(c("<option/>", f._parseJSON(a)));
    ...
    e.remove = function (a, b) {
        var d = this, e = c.type(a), h = 0, g, n = "";
        if ("array" === e) {
            for (g = a.length; h <= g - 1; h += 1)e = a[h], "number" === c.type(e) && (n = n.length ? n + (", option:eq(" + e + ")") : n + ("option:eq(" + e + ")"));
